      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex flex-col lg:flex-row justify-center gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="w-full lg:w-[600px]">
            ...
            <div className="text-left mb-8 sm:mb-12 space-y-4 sm:space-y-6">
              <p className="text-neutral-80 dark:text-neutral-20 text-base sm:text-lg md:text-xl leading-[150%] max-w-full lg:max-w-4xl mx-auto">
                ...
                >
                  we uncovered key insights that shaped the direction of our
                  design decisions.
                </span>{" "}
                Here are the most significant findings from our research
                process.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:gap-8 lg:gap-12">
              {/* Early Insights */}
              <div className="bg-neutral-3 dark:bg-neutral-90 backdrop-blur-sm border border-neutral-100/10 dark:border-neutral-90/10 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10">
                    ...
                    <div className="relative group">
                      ...
                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 w-80 sm:w-96">
                        <div className="bg-neutral-100 dark:bg-neutral-0 text-neutral-0 dark:text-neutral-100 px-4 sm:px-6 py-3 sm:py-4 rounded-lg shadow-lg border border-neutral-200 dark:border-neutral-80 text-xs sm:text-sm leading-relaxed">
                          ...
                          <div className="mb-3">
                            <img
                              src="/assets/case-study-assets/emplojd/Emplojd-Insights-Gradual-AI-Automation-Example.svg"
