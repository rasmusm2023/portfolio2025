      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="w-full h-[500px] sm:h-[500px] md:h-[600px] lg:h-[800px] xl:h-[987px] relative rounded-2xl overflow-hidden mb-8 sm:mb-12 lg:mb-16">
          ...
          <div className="absolute inset-0 w-full h-full hidden sm:block">
            ...
            >
              <img
                src="/assets/case-study-assets/emplojd/Emplojd-Results-Cover-Letter-Generation-Flow.svg"
            ...
            >
              <img
                src="/assets/case-study-assets/emplojd/Emplojd-Results-Saved-Cover-Letters-Flow.svg"
            ...
            >
              <img
                src="/assets/case-study-assets/emplojd/Emplojd-Results-User-Profile-States.svg"
            ...
            >
              ...
              >
                <div className="w-full h-full bg-neutral-800 rounded-[18px] sm:rounded-[20px] md:rounded-[22px] lg:rounded-[30px] xl:rounded-[30px] overflow-hidden relative">
                  ...
                  >
                    <source
                      src="/assets/case-study-assets/emplojd/Emplojd_Results_Cover_Letter_Generation_Flow.webm"
                      type="video/webm"
                    />
                  </video>
            ...
            >
              ...
              >
                <div className="w-full h-full bg-neutral-800 rounded-[18px] sm:rounded-[20px] md:rounded-[22px] lg:rounded-[30px] xl:rounded-[30px] overflow-hidden relative">
                  ...
                  >
                    <source
                      src="/assets/case-study-assets/emplojd/Emplojd_Results_Saved_Cover_Letters_Flow.webm"
                      type="video/webm"
                    />
                  </video>
                  {/* Dark overlay for non-active prototypes */}
            ...
            >
              ...
              >
                <div className="w-full h-full bg-neutral-800 rounded-[18px] sm:rounded-[20px] md:rounded-[22px] lg:rounded-[30px] xl:rounded-[30px] overflow-hidden relative">
                  ...
                  >
                    <source
                      src="/assets/case-study-assets/emplojd/Emplojd_Results_User_Profile_States.webm"
                      type="video/webm"
                    />
                  </video>
                  {/* Dark overlay for non-active prototypes */}
