...
const projects: Project[] = [
  {
    ...
    image:
      "/assets/case-study-assets/emplojd/Emplojd-Results-Shot-Menu-Search-Job-Search-Results.png",
          ...
          <div className="flex flex-row gap-4 lg:gap-8 bg-neutral-10/20 dark:bg-white/20 backdrop-blur-sm px-4 lg:px-6 py-3 lg:py-4 shadow-lg border-2 border-[#8B5CF6]/30">
              ...
              <Image
                src={
                  lastHoveredProject === "emplojd"
                    ? "/assets/case-study-assets/emplojd/EMPLOJD-Preview-1.svg"
            ...
            <div className="w-[150px] h-[150px] lg:w-[200px] lg:h-[200px] rounded-lg overflow-hidden bg-neutral-20 dark:bg-neutral-80">
              <Image
                src={
                  lastHoveredProject === "emplojd"
                    ? "/assets/case-study-assets/emplojd/EMPLOJD-Preview-2.svg"
            ...
            <div className="w-[150px] h-[150px] lg:w-[200px] lg:h-[200px] rounded-lg overflow-hidden bg-neutral-20 dark:bg-neutral-80">
              <Image
                src={
                  lastHoveredProject === "emplojd"
                    ? "/assets/case-study-assets/emplojd/EMPLOJD-Preview-3.svg"
